...
pip install llama-cpp-python==0.2.79 numpy==1.26.4 pandas==2.1.4 --force-reinstall --no-cache-dir --extra-index-url https://abetlen.github.io/llama-cpp-python/whl/cu122
